                ...
                <Container>
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        <Nav className="me-auto">
                            ...
                            {admin && <Nav.Link as={HashLink} to="/dashboard"><i class="fas fa-tachometer-alt"></i> DASHBOARD</Nav.Link>|| <Nav.Link as={HashLink} to="/addBlogs"><i class="fas fa-hotel"></i> ADD YOUR EXPERIENCE</Nav.Link> }
